...
import my.controller.InvActnListener;
import my.controller.TblSlctnListener;
...
public class SalesInvFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        invHTbl.setBackground(new java.awt.Color(0, 153, 153));
        ...
        invLTbl.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private InvActnListener actionListener = new InvActnListener(this);
    private ArrayList<InvoiceHeader> invoicesArray;
    private ArrayList<InvoiceLine> linesArray;
    private InvHeaderTblMdl headerTableModel;
    public static SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
    private TblSlctnListener selectionListener = new TblSlctnListener(this);
    ...
    public InvHeaderTblMdl getHeaderTblMdl() {
        return headerTableModel;
    }

    public void setHeaderTableModel(InvHeaderTblMdl headerTableModel) {
    ...
    public InvActnListener getActionListener() {
